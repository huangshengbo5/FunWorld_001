...
func NewTester02(id uint32) (r *battle.FighterRuntime) {
	skill10021 := &battle.SkillInfo{
		SkillID:     10021,
		...
		Effect: &battle.Effect10002{
			&battle.EffectBase{
				...
				EffectVal1:        14200, //142%普通
			},
		},
	}

	skill10022 := &battle.SkillInfo{
		SkillID:     10022,
		TriggerType: constant.TriggerAfterAttack,
		Probability: 2000, //20%技能发动
		Effect: &battle.Effect10005{
			&battle.EffectBase{
				Target:            constant.TargetEnemy,
				EffectID:          10005,
				EffectProbability: 10000, //100%生效
	...
	skill10023 := &battle.SkillInfo{
		...
		Effect: &battle.Effect10002{
			&battle.EffectBase{
				...
				EffectID:          10002,
				EffectProbability: 10000, //100%生效
				EffectVal1:        17000, //170%普通伤害
				SubEffects: []battle.IEffect{&battle.Effect10005{
					&battle.EffectBase{
						Target:            constant.TargetEnemy,
						EffectID:          10005,
						EffectProbability: 10000, //100%生效
	...
	r = &battle.FighterRuntime{
		...
		Skills: map[constant.TriggerType][]*battle.SkillInfo{
			constant.TriggerDefault:     []*battle.SkillInfo{skill10021},
			constant.TriggerZXC:         []*battle.SkillInfo{skill10023},
			constant.TriggerAfterAttack: []*battle.SkillInfo{skill10022},
		},
	}
