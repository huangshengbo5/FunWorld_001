...
func NewTester05(id uint32) (r *battle.FighterRuntime) {
	skill10051 := &battle.SkillInfo{
		SkillID:     10051,
	...
	skill10052 := &battle.SkillInfo{
		SkillID:     10052,
		TriggerType: constant.TriggerAfterAttack,
		Probability: 1400, //14%技能发动
		Effect: &battle.Effect10006{
			&battle.EffectBase{
	...
	r = &battle.FighterRuntime{
		...
		Skills: map[constant.TriggerType][]*battle.SkillInfo{
			constant.TriggerDefault:     []*battle.SkillInfo{skill10051},
			constant.TriggerZXC:         []*battle.SkillInfo{skill10053},
			constant.TriggerAfterAttack: []*battle.SkillInfo{skill10052},
		},
	}
